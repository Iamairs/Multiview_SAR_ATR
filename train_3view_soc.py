...
from model.swinT_cosatt_3view import SwinTransformer
...
depth = '111111'
dropout = '000'
dataset_path = project_root + "/dataset" + "/soc/"
...
def main():
    ...
    # model
    model = SwinTransformer(in_chans=input_view, num_classes=num_classes, embed_dim=48,
